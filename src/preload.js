...
function preloadMapTiles(game) {
  ...
  for (var i = 0; i < 13; i++) {
    image = "grass-" + i;
    game.load.image(image, "assets/tiles/grass/" + image + ".png");
  }
  ...
  // ==============================
  image = "forest-1-0";
  game.load.image(image, "assets/tiles/forest/" + image + ".png");
  image = "forest-1-1";
  game.load.image(image, "assets/tiles/forest/" + image + ".png");
  image = "forest-1-2";
  game.load.image(image, "assets/tiles/forest/" + image + ".png");
  ...
  // ==============================
  image = "mountain-1";
  game.load.image(image, "assets/tiles/mountain/" + image + ".png");
  ...
  for (const baseImage of directional) {
    // 0
    image = baseImage + "-0-";
    game.load.image(image, "assets/tiles/" + baseImage + "/" + image + ".png");
  ...
  for (var i = 0; i < 4; i++) {
    image = "wall-2-we-" + i;
    game.load.image(image, "assets/tiles/wall/" + image + ".png");
  }

  // Alternate stone tiles
  for (var i = 0; i < 8; i++) {
    image = "stone-" + i;
    game.load.image(image, "assets/tiles/stone/" + image + ".png");
  }
  ...
  // ==============================
  image = "bridge-0-h";
  game.load.image(image, "assets/tiles/bridge/" + image + ".png");
  image = "bridge-0-v";
  game.load.image(image, "assets/tiles/bridge/" + image + ".png");
